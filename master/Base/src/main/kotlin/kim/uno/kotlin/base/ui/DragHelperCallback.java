...
public class DragHelperCallback extends ItemTouchHelper.Callback {
    ...
    public void onSelectedChanged(RecyclerView.ViewHolder viewHolder, int actionState) {
        if (actionState != ItemTouchHelper.ACTION_STATE_IDLE && viewHolder instanceof DragViewHolder) {
            ((DragViewHolder) viewHolder).onSelectedChanged(true);
        }
    ...
    public boolean canDropOver(RecyclerView recyclerView, RecyclerView.ViewHolder current, RecyclerView.ViewHolder target) {
        if (target instanceof DragViewHolder) {
            return ((DragViewHolder) target).isSwapable();
        }
